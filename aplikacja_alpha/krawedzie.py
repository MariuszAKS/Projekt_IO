...
# arg do konstruktora to obraz w formie numpy array/ścieżka do pliku
# zmien_obraz(), żeby zmienić aktualnie analizowany obraz
class Krawedzie:
    ...
    # zwraca maske krawędzi (2d numpy bool array)
    def maska(self):
