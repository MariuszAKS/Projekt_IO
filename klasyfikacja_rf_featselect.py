...
def klasyfikacja_wrapper():
    ...
    #dopasowuje kalkulacje (silnik robi brr brr i dopasowuje cechy) i zwraca wybrane cechy
    ...
    #nieudana próba zastosowania fcbf
    #fcbf.fcbf_wrapper("cechy1.csv", thresh=0.0005, delim=',', header=True, classAt=1)
