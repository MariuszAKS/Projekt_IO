# Form implementation generated from reading ui file 'c:\Users\konra\OneDrive\Pulpit\repo\Projekt_IO\gui\zawartosc\designer\gui_designer.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.boczny = QtWidgets.QWidget(self.centralwidget)
        self.boczny.setEnabled(True)
        self.boczny.setMinimumSize(QtCore.QSize(67, 0))
        self.boczny.setMaximumSize(QtCore.QSize(67, 16777215))
        self.boczny.setObjectName("boczny")
        self.boczny.setStyleSheet("background-color: #DDDDDD")
        self.layoutWidget = QtWidgets.QWidget(self.boczny)
        self.layoutWidget.setGeometry(QtCore.QRect(0, 0, 67, 783))
        self.layoutWidget.setObjectName("layoutWidget")
        self.pasek_boczny = QtWidgets.QVBoxLayout(self.layoutWidget)
        self.pasek_boczny.setContentsMargins(0, 50, 0, 0)
        self.pasek_boczny.setObjectName("pasek_boczny")
        self.przycisk_dodaj = QtWidgets.QPushButton(self.layoutWidget)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Users\\konra\\OneDrive\\Pulpit\\repo\\Projekt_IO\\gui\\zawartosc\\designer\\../../zasoby/ikony/plus.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.przycisk_eksport = QtWidgets.QPushButton(self.layoutWidget)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("c:\\Users\\konra\\OneDrive\\Pulpit\\repo\\Projekt_IO\\gui\\zawartosc\\designer\\../../zasoby/ikony/save.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.przycisk_wyczysc = QtWidgets.QPushButton(self.layoutWidget)
        self.przycisk_wyczysc.setMinimumSize(QtCore.QSize(0, 65))
        self.przycisk_wyczysc.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("c:\\Users\\konra\\OneDrive\\Pulpit\\repo\\Projekt_IO\\gui\\zawartosc\\designer\\../../zasoby/ikony/trash.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.przycisk_zmien_uklad = QtWidgets.QPushButton(self.layoutWidget)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("c:\\Users\\konra\\OneDrive\\Pulpit\\repo\\Projekt_IO\\gui\\zawartosc\\designer\\../../zasoby/ikony/list.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.horizontalLayout_2.addWidget(self.boczny)
        ...
        self.przycisk_zdjecie.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        self.przycisk_zdjecie.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.przycisk_zdjecie.setAutoDefault(False)
        self.przycisk_zdjecie.setDefault(False)
